...
public class FileManagerSearchActivity extends AbsBaseActivity {
    ...
    protected void serviceConnected() {
        ...
        if(!PermissionUtils.hasStorageReadPermission(getApplicationContext())){
            LogUtils.i(TAG, "serviceConnected,read permission not present");
            return;
        }
    ...
    private void handleIntent(Intent intent) {
        LogUtils.d(TAG, "handleIntent, intent.getAction() = "+ intent.getAction());
        ...
        if (mService != null) {
            if (selectedFileInfo.isDirectory()) {
                ...
                if (canOpen) {
                    ...
                    Uri uri = selectedFileInfo.getItemContentUri(this);
                    LogUtils.d(TAG, "Open uri file: " + uri + "with mimetype =" + mimeType);
