...
public abstract class AbsBaseActivity extends Activity implements OnItemClickListener,
    ...
    public static final int MY_PERMISSIONS_REQUEST_TO_READ_EXTERNAL_STORAGE = 11;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(mSavedInstanceState != null){
            ...
            if (savePath != null
                ...
                LogUtils.d(TAG, "onCreate, mCurrentPath updated to = "+mCurrentPath);
            }
        }
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_TO_READ_EXTERNAL_STORAGE:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if(!PermissionUtils.showReadRational(AbsBaseActivity.this)){
    ...
    protected class TabManager {
        ...
        protected void updateNavigationBar(int id) {
            ...
            //Error handling,  mntPointPath length should not exceed mCurFilePath length
            String mntPointPath = mMountPointManager.getRealMountPointPath(mCurFilePath);
            if( id!=0 && (mntPointPath.length() >= mCurFilePath.length() )){
                return;
            }
    ...
    protected void showDirectoryContent(String path) {
        ...
        if(!PermissionUtils.hasStorageReadPermission(getApplicationContext())){
            LogUtils.i(TAG, "showDirectoryContent,read permission not present");
            return;
        }
        if (isFinishing()) {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        LogUtils.d(TAG, "onSaveInstanceState , mCurrentPath = "+mCurrentPath);
        if (mCurrentPath != null) {
