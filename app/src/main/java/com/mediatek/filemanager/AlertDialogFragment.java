...
import android.app.EditTextDialog;
...
public class AlertDialogFragment extends DialogFragment implements
    ...
    protected Builder createAlertDialogBuilder(Bundle savedInstanceState) {
        ...
        /**
         * Mod by XMIC-guokun.hou on 2017/6/7 14:45 Start ----------
         * Issue: common stytle
         * Solution: add  , R.style.tpv_dialog
         */

        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity() );   //, R.style.tpv_dialog
        //Mod by XMIC-guokun.hou on 2017/6/7 14:45 End ----------
        if (args != null) {
    ...
    public static class EditTextDialogFragment extends AlertDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            /**
             * Mod by XMIC-guokun.hou on 2017/6/6 9:15 Start ----------
             * Issue: 3 location need be commented
             * Solution: use tpv Dialog common style
             */
            //location 1
            AlertDialog.Builder builder = createAlertDialogBuilder(savedInstanceState);
//            EditTextDialog builder = new EditTextDialog(getActivity(), R.style.tpv_editText_dialog );    //,R.style.tpv_editText_dialog
...
//                mEditText = builder.getEditTextView();
                if (mEditText != null) {
            ...
            return builder.create();
//            return builder;
            //Mod by XMIC-guokun.hou on 2017/6/6 9:15 End ----------
        }
